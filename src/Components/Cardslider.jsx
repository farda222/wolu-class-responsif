  ...
  return (
    <>
      <div data-aos="fade-out" data-aos-duration="1000" data-aos-delay="600" className="container flex justify-center align-middle sm:mx-auto md:mx-auto lg:mx-auto 2xl:mx-auto mb-20">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 2xl:gap-20 lg:mt-10">
          <div
            id="Card-head"
            className="w-40 h-40 bg-white border-2 border-neutral-400 border-solid rounded-md hover:border-2 overflow-y-hidden hover:bg-indigo-600 hover:text-white transition-all px-3 pt-6 text-black text-xs lg:text-base font-semibold lg:w-72 lg:h-72 lg:pt-14 lg:px-9"
            data-tilt>
            ...
            <p className="w-40 lg:text-base lg:font-normal lg:w-56 lg:mt-5">Managing exams and assessment converence</p>
          </div>
          <div
            id="Card-head"
            className="w-40 h-40 bg-white border-2 border-neutral-400 border-solid rounded-md hover:border-2 overflow-y-hidden hover:bg-indigo-600 hover:text-white transition-all px-3 pt-6 text-black text-xs font-semibold lg:w-72 lg:h-72 lg:pt-14 lg:px-9"
            data-tilt>
            ...
            <p className="lg:text-base lg:font-normal lg:w-56 lg:mt-5">Ask anything to the teacher in real-time.</p>
          </div>
          <div
            id="Card-head"
            className="w-40 h-40 bg-white border-2 border-neutral-400 border-solid rounded-md hover:border-2 overflow-y-hidden hover:bg-indigo-600 hover:text-white transition-all peer px-3 pt-6 text-black text-xs font-semibold lg:w-72 lg:h-72 lg:pt-14 lg:px-9"
            data-tilt>
            <div className="bg-indigo-600 w-fit p-2 rounded-md mb-3 lg:py-[1rem] lg:px-[1rem] lg:w-[3.7rem] lg:rounded-xl">
            ...
            <p className="lg:text-base lg:font-normal lg:w-56 lg:mt-5">Direct interaction with teachers and students.</p>
          </div>
          <div
            id="Card-head"
            className="w-40 h-40 bg-white border-2 border-neutral-400 border-solid rounded-md hover:border-2 overflow-y-hidden hover:bg-indigo-600 hover:text-white transition-all peer px-3 pt-6 text-black text-xs font-semibold lg:w-72 lg:h-72 lg:pt-14 lg:px-9"
            ...
            <p className="lg:text-base lg:font-normal lg:w-56 lg:mt-5">Teachers and students in one tap.</p>
          </div>
        </div>
      </div>
    </>
