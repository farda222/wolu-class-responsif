...
const Navbar = () => {
  ...
  return (
    <nav className={`font-custom shadow-md transition-all duration-300 ease-in-out fixed w-full px-5 py-7 border-b-[0.5px] border-solid border-neutral-500  z-50 lg:border-none ${isNavbarTransparent ? "bg-transparent" : "bg-white"}`}>
