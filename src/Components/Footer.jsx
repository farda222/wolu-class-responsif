...
const Footer = () => {
  return (
    <footer className="bg-white text-black py-8 mt-36">
      <div className="text-center mb-4 flex mx-auto justify-center items-center container lg:float-start lg:-ml-[35rem] lg:mt-10">
      ...
      <div className="flex items-center justify-center container mx-auto mb-4 gap-7 mt-14 lg:gap-60">
      ...
      <div className="flex items-center justify-center container mx-auto mt-14 -ml-20 lg:-ml-[38rem] lg:-mt-5 ">
      ...
      <p className="text-xs text-center w-40 lg:text-base lg:text-left float-end -mt-12 mr-5 lg:float-start lg:-mt-24 ml-20">Enjoy your learning with our service</p>
